  ...
  if (!canManage) {
    return (
      <div className="space-y-6">
        <AlertBanner tone="warning" message="You don't have permission to manage roles." />
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            {isError && (
              <div className="p-6">
                <AlertBanner tone="error" message="Failed to load roles." />
              </div>
            )}
                      ...
                      {isEditing && (
                        <div className="space-y-4 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-4">
                          ...
                          {updateMutation.isError && (
                            <AlertBanner
                              tone="error"
                              message="Failed to update role. Check console for details."
                            />
                          )}
                        </div>
                      )}
