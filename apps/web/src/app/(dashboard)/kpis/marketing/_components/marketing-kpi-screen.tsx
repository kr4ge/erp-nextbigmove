...
import { TeamTargetForm } from './team-target-form';
import { CategoryTargetForm } from './category-target-form';
import { UserCategoryAssignmentForm } from './user-category-assignment-form';
import { UserTargetOverrideForm } from './user-target-override-form';
import { TeamCategoryHistory } from './team-category-history';
...
type MarketingKpiScreenProps = {
  variant?: 'standalone' | 'settings';
};

export function MarketingKpiScreen({
  variant = 'standalone',
}: MarketingKpiScreenProps) {
  const {
    selectedTeamCode,
    setSelectedTeamCode,
    filterStartDate,
