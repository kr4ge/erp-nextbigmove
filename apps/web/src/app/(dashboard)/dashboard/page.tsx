...
import { CeoDashboardScreen } from "../ceo/_components/ceo-dashboard-screen";
...
export default function DashboardPage() {
  ...
  // The executive dashboard is now the CEO business dashboard, which owns its
  // own data fetching and economics — see (dashboard)/ceo.
  const renderExecutiveDashboard = () => <CeoDashboardScreen />;
