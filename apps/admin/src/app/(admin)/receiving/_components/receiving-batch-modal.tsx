    ...
    >
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_300px]">
                    ...
                    <tr key={line.id}>
                      ...
                      <td className="px-4 py-3 text-right">
                        <input
                          ...
                          className="h-9 w-24 rounded-[12px] border border-[#d7e0e7] bg-white px-3 text-right text-[13px] font-semibold text-primary outline-none transition focus:border-[#96b4c3]"
                        />
                      </td>
                    </tr>
                  ))}
        ...
        <div className="space-y-3">
          <div className="card">
            <p className="card-label">Warehouse</p>
            <div className="mt-2">
              <WmsSearchableSelect
                label="Warehouse"
                value={warehouseId}
          ...
          <div className="card">
            ...
            <textarea
              ...
              className="mt-2 w-full rounded-[14px] border border-[#d7e0e7] bg-[#fbfcfc] px-3 py-2.5 text-[13px] text-primary outline-none transition placeholder:text-[#94a3b8] focus:border-[#96b4c3]"
            />
          </div>
        </div>
      </div>
