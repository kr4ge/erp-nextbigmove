    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div>
          ...
          <h1 className="wms-page-title mt-3 font-semibold tracking-tight text-primary">{title}</h1>
        </div>
      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.78fr)]">
        <div className="wms-surface border border-[#dce4ea] bg-white shadow-[0_24px_60px_-42px_rgba(18,56,75,0.36)]">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <h2 className="wms-section-title mt-3 font-semibold tracking-tight text-primary">Next steps</h2>
            </div>
          ...
          <div className="mt-5 grid gap-3.5 sm:grid-cols-2">
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <p className="mt-3 text-[14px] font-medium leading-6 text-primary">{milestone}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <aside className="wms-surface border border-[#dce4ea] bg-white shadow-[0_24px_60px_-42px_rgba(18,56,75,0.36)]">
          ...
          <h2 className="wms-section-title mt-3 font-semibold tracking-tight text-primary">Focus</h2>
