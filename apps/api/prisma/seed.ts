...
const PERMISSIONS: { key: string; description: string }[] = [
  ...
  { key: 'sms.inbox.read', description: 'Read tenant SMS conversations and message history' },
  { key: 'sms.messages.send', description: 'Send one-to-one SMS messages' },
  { key: 'sms.templates.manage', description: 'Create and manage tenant SMS templates' },
  { key: 'sms.devices.manage', description: 'Enroll, configure, and revoke tenant SMS devices' },
  { key: 'sms.routes.manage', description: 'Configure store-to-SIM routing and fallback order' },
  { key: 'sms.settings.manage', description: 'Manage tenant SMS limits and settings' },
  { key: 'sms.logs.read', description: 'Read SMS delivery events and gateway diagnostics' },
  { key: 'sms.messages.redact', description: 'Redact SMS message content with an audit event' },
