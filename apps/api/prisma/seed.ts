...
const ROLES: RoleDef[] = [
  ...
  },
  {
    ...
    scope: RoleScope.TEAM,
    permissions: ['integration.read', 'workflow.execute', 'meta.read', 'analytics.marketing'],
    isSystem: true,
  },
  {
    key: 'SALES',
    ...
    scope: RoleScope.TEAM,
    permissions: ['pos.read', 'analytics.sales'],
    isSystem: true,
  },
  {
    key: 'FUNNEL',
    ...
    scope: RoleScope.TEAM,
    permissions: ['analytics.marketing', 'analytics.sales'],
    isSystem: true,
  },
];
